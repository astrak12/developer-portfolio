...
export const GitHubActivity: React.FC = () => {
    ...
    const [selectedYear, setSelectedYear] = useState<number>(2026); // Tahun aktif sesuai referensi
    ...
    return (
        <section id="github" className="py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto border-t border-slate-200 dark:border-slate-800">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
                <div className="bg-surface dark:bg-surface-dark border border-slate-200 dark:border-slate-800 rounded-major p-6 shadow-subtle flex flex-col justify-between">
                    <div className="flex items-center space-x-3 mb-2">
                        ...
                        <span className="font-mono text-xs text-slate-500 uppercase">Repositori</span>
                    </div>
                    <div className="text-3xl font-bold font-sans text-slate-900 dark:text-white">
                        {repos.length} <span className="text-xs font-mono font-normal text-slate-500 block">Repositori dibuat</span>
                    </div>
                </div>
                ...
                <div className="bg-surface dark:bg-surface-dark border border-slate-200 dark:border-slate-800 rounded-major p-6 shadow-subtle flex flex-col justify-between">
                    ...
                    <div className="text-3xl font-bold font-sans text-accent">
                        1 <span className="text-xs font-mono font-normal text-slate-500 block">Repositori kontribusi</span>
                    </div>
                </div>
                ...
                <div className="bg-surface dark:bg-surface-dark border border-slate-200 dark:border-slate-800 rounded-major p-6 shadow-subtle flex flex-col justify-between">
                    <div className="flex items-center space-x-3 mb-2">
                        ...
                        <span className="font-mono text-xs text-slate-500 uppercase">Timeline</span>
                    </div>
                    <div className="text-3xl font-bold font-sans text-slate-900 dark:text-white">
                        2022 <span className="text-xs font-mono font-normal text-slate-500 block">Aktif sejak</span>
                    </div>
                </div>
            </div>

            {/* Kotak Heatmap Kontribusi Style @RIOIVANO */}
            <div className="bg-surface dark:bg-surface-dark border border-slate-200 dark:border-slate-800 rounded-major p-8 shadow-subtle mb-12 overflow-x-auto">
                ...
                {/* Header Bagian Atas Heatmap: Jumlah Kontribusi & Tombol Tahun */}
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
                    <div>
                        <h3 className="text-lg font-bold font-sans text-slate-900 dark:text-white">
                            Kontribusi pada {selectedYear}
                        </h3>
                        <p className="text-xs font-mono text-slate-500">
                            @{githubUsername.toUpperCase()} activity stream
                        </p>
                    </div>

                    <div className="flex items-center space-x-4">
                        {/* Tombol Pilihan Tahun (2026 s.d 2022) */}
                ...
                {/* Label Bulan Bahasa Indonesia (Jan - Des) di atas Heatmap */}
                <div className="hidden sm:flex justify-between text-[11px] font-mono text-slate-400 px-6 max-w-4xl mx-auto mb-1">
                    <span>Jan</span>
                    <span>Feb</span>
                    <span>Mar</span>
                    <span>Apr</span>
                ...
                {/* Grafik Kontribusi Nyata Berbasis SVG */}
